...
MODEL_MAP   = {
    ...
    "ReFIne-qwen3-1.7b-sft-only": "ReFIne-qwen3-1.7b-sft-only",
    "ReFIne-qwen3-4b-sft-only": "ReFIne-qwen3-4b-sft-only",
    "ReFIne-qwen3-8b-sft-only": "ReFIne-qwen3-8b-sft-only",

    "ReFIne-qwen3-1.7b": "ReFIne-qwen3-1.7b",
    "ReFIne-qwen3-4b": "ReFIne-qwen3-4b",
    "ReFIne-qwen3-8b": "ReFIne-qwen3-8b",

    "Plain-qwen3-1.7b-sft-only": "Plain-qwen3-1.7b-sft-only",
    "Plain-qwen3-4b-sft-only": "Plain-qwen3-4b-sft-only",
    "Plain-qwen3-8b-sft-only": "Plain-qwen3-8b-sft-only",

    "Plain-qwen3-1.7b": "Plain-qwen3-1.7b",
    "Plain-qwen3-4b": "Plain-qwen3-4b",
    "Plain-qwen3-8b": "Plain-qwen3-8b",
}
